            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body animated-form">
                        <form action="{{ route('admin-kegiatan-store') }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation custom-input">
                            @csrf
                            @method('POST')
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="content" id="summernote" rows="6" required>{{ old('content') }}</textarea>
                            </div>
                            ...
                            <div class="col-12">
                                @include('components.buttonForm', ['route' => 'admin-kegiatan'])
                            </div>
                        </form>
                    </div>
                </div>
