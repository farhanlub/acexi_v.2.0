            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body animated-form">
                        <form action="{{ route('admin-akun-member-update', $pengurus->id) }}" method="POST" class="row g-3 needs-validation custom-input">
                            @csrf
                            @method('PUT')
                            <div class="col-12 position-relative">
                                ...
                                <select name="pengurus_id" class="select2 form-control" id="validationTooltip04" required="">
                                    <option selected value="{{ $pengurus->member->id }}">{{ $pengurus->member->nama_lengkap }}</option>
