    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin-data-mitra-store') }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation">
                            @csrf
                            @method('POST')
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control" name="website_url" id="website_url" type="url" value="{{ old('website_url') }}">
                            </div>
