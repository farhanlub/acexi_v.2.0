            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body animated-form">
                        <form action="{{ route('admin-peraturan-regulasi-kebijakan-update', $regulation->id) }}" method="POST" class="row g-3 needs-validation">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-control" id="regulation_categories_id" name="regulation_categories_id" required>
                                    <option value="" selected disabled>Pilih Hierarki</option>
