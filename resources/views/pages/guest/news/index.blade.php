            ...
            <div class="col-lg-8">
                <div class="sidebar-wrapper">
                            ...
                            <div class="tj-video-area">
                                <div class="video-box">
                                    <div class="circle pulse video-icon">
                                        <a class="popup-videos-button" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=ADmQTw4qqTY">
                    ...
                    <div class="details-item last-item">
                        <div class="swiper tj-wrapper-slider swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                            <div class="swiper-wrapper" id="swiper-wrapper-ca59accc7e8afcb2" aria-live="off" style="transform: translate3d(-2160px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="2" role="group" aria-label="3 / 3" style="width: 696px; margin-right: 24px;">
                                    <div class="blog-thumb-image">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-8.jpg" alt="Image"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate-next" data-swiper-slide-index="0" role="group" aria-label="1 / 3" style="width: 696px; margin-right: 24px;">
                                    <div class="blog-thumb-image">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-9.jpg" alt="Image"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="1" role="group" aria-label="2 / 3" style="width: 696px; margin-right: 24px;">
                                    <div class="blog-thumb-image">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-7.jpg" alt="Image"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="2" role="group" aria-label="3 / 3" style="width: 696px; margin-right: 24px;">
                                    <div class="blog-thumb-image">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-8.jpg" alt="Image"></a>
                                    </div>
                                </div>
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-next" data-swiper-slide-index="0" role="group" aria-label="1 / 3" style="width: 696px; margin-right: 24px;">
                                    <div class="blog-thumb-image">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-9.jpg" alt="Image"></a>
                                    </div>
                                </div></div>
                            <div class="wrapper-navigation">
                                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-ca59accc7e8afcb2"></div>
                                <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-ca59accc7e8afcb2"></div>
                            </div>
                    ...
                    <div class="tj-blog-widget">
                        ...
                        <div class="sidebar-recent-post">
                            <div class="single-post d-flex align-items-center">
                                <div class="post-image">
                                    <a href="blog-details.html">
                                        <img src="assets/images/blog/post-3.jpg" alt="Blog"></a>
                                </div>
                            ...
                            <div class="single-post d-flex align-items-center">
                                <div class="post-image">
                                    <a href="blog-details.html">
                                        <img src="assets/images/blog/post-4.jpg" alt="Blog"></a>
                                </div>
                                <div class="post-content">
                                    <div class="blog-meta">
                                        <ul>
                            ...
                            <div class="single-post d-flex align-items-center">
                                <div class="post-image">
                                    <a href="blog-details.html">
                                        <img src="assets/images/blog/post-5.jpg" alt="Blog"></a>
                                </div>
                                <div class="post-content">
                                    <div class="blog-meta">
                                        <ul>
