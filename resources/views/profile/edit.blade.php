                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="tj-team-item">
                                <div class="team-image shadow-sm">
                                    <!-- Preview Image -->
                                    <img id="profile-image" src="{{ Auth::user()->pengurus->image != null ? asset(Auth::user()->pengurus->image) : 'https://static.vecteezy.com/system/resources/thumbnails/005/129/844/small_2x/profile-user-icon-isolated-on-white-background-eps10-free-vector.jpg' }}" alt="Image" class="img-fluid">
                                </div>
                                <div class="form-group mt-3">
                                    <!-- Image Upload -->
                                    <label for="image-upload" class="btn btn-light border"><i class="fa fa-upload me-2"></i> Unggah gambar</label>
                            ...
                            <div class="shadow-sm rounded p-2">
                                ...
                                <table class="table table-striped">
                                    <tr>
                                        <td class="text-nowrap">Nama</td>
                                        <td>
                                            <input type="text" class="form-control border" name="name" value="{{ old('name', Auth::user()->pengurus->name) }}">
                                            @error('name')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Email</td>
                                        <td>
                                            <input type="email" class="form-control" readonly disabled value="{{ Auth::user()->pengurus->email }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-nowrap">Facebook</td>
                                        <td>
                                            <input type="text" class="form-control border" name="facebook" value="{{ old('facebook', Auth::user()->pengurus->facebook) }}">
                                            @error('facebook')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">LinkedIn</td>
                                        <td>
                                            <input type="text" class="form-control border" name="linkedin" value="{{ old('linkedin', Auth::user()->pengurus->linkedin) }}">
                                            @error('linkedin')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control border" name="twitter" value="{{ old('twitter', Auth::user()->pengurus->twitter) }}">
                                            @error('twitter')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control border" name="instagram" value="{{ old('instagram', Auth::user()->pengurus->instagram) }}">
                                            @error('instagram')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
